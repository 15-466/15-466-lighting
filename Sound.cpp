...
std::shared_ptr< Sound::PlayingSample > Sound::play(Sample const &sample, float pan, float vol) {
	std::shared_ptr< Sound::PlayingSample > playing_sample = std::make_shared< Sound::PlayingSample >(sample, vol, pan, false);
	lock();
...
std::shared_ptr< Sound::PlayingSample > Sound::play_3D(Sample const &sample, float vol, glm::vec3 const &position, float half_volume_radius) {
	std::shared_ptr< Sound::PlayingSample > playing_sample = std::make_shared< Sound::PlayingSample >(sample, vol, position, half_volume_radius, false);
	lock();
	playing_samples.emplace_back(playing_sample);
	unlock();
	return playing_sample;
...
std::shared_ptr< Sound::PlayingSample > Sound::loop(Sample const &sample, float pan, float vol) {
	std::shared_ptr< Sound::PlayingSample > playing_sample = std::make_shared< Sound::PlayingSample >(sample, vol, pan, true);
	lock();
	playing_samples.emplace_back(playing_sample);
	unlock();
	return playing_sample;
...
std::shared_ptr< Sound::PlayingSample > Sound::loop_3D(Sample const &sample, float vol, glm::vec3 const &position, float half_volume_radius) {
	std::shared_ptr< Sound::PlayingSample > playing_sample = std::make_shared< Sound::PlayingSample >(sample, vol, position, half_volume_radius, true);
	lock();
	playing_samples.emplace_back(playing_sample);
	unlock();
	return playing_sample;
